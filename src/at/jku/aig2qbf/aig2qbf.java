	...
	public static void main(String[] args) {
		...
		try {
			...
			if (commandLine.hasOption('i')) {
				...
				if (extension == null) {
					throw new RuntimeException(String.format("Unknown extension for input file \"%s\"", filename));
				}
			}
			if (commandLine.hasOption('o')) {
				...
				if (extension == null) {
					throw new RuntimeException(String.format("Unknown extension for output file \"%s\"", filename));
				}
			}
			...
			if (commandLine.hasOption('i')) {
				...
				Extension inputExtension = Parser.getExtension(input);
				...
				if (commandLine.hasOption("visualize")) {
					...
					if (commandLine.hasOption('o')) {
						f.writeToFile(t, commandLine.getOptionValue('o'));
					}
					else {
